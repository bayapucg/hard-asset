            ...
            <ul>
                ...
                <li class="submenu">
                    ...
                    <ul class="list-unstyled" style="display: none;">
                        ...
                        <li><a href="<?php echo base_url('services/lists'); ?>">Services List</a></li>
                ...
                <li class="">
                    <a href="<?php echo base_url('payment'); ?>">Payment<span class="menu-arrow"></span></a>
                </li>
                <li class="">
                    <a href="<?php echo base_url('request_service'); ?>">Request for Other Services<span class="menu-arrow"></span></a>
                </li>
            </ul>
        </div>
    </div>
